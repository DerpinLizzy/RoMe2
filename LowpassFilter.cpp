...
/**
 * Creates a LowpassFilter object with a default cutoff frequency of 1000
 * [rad/s].
 */
LowpassFilter::LowpassFilter() {
  ...
  b1 = (1.0f - (1.0f + frequency * period) * exp(-frequency * period)) /
       frequency / frequency;
 ...
 * This is typically the sampling period of the periodic task of a controller
 ...
 */
float LowpassFilter::getFrequency() { return frequency; }
